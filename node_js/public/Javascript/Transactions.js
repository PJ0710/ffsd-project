...
$("#new_row").on("click", function (e) {
  e.preventDefault();
  $("#tbl").append(
    '<tr><td><input class="record" type="date" name="date' +
      window.i +
      '" id="Date' +
      window.i +
      '"></td><td><input type="text" name="ticker' +
      window.i +
      '" id="Ticker' +
      window.i +
      '"></td><td><select id="select' +
      window.i +
      '" name="select' +
      window.i +
      '"><option value="Buy">Buy</option><option value="Sell">Sell</option></select></td><td><input type="text" onchange="check3()" name="quantity' +
      window.i +
      '" id="Quantity' +
      window.i +
      '"></td><td><input type="number" onchange="check3()" name="price' +
      window.i +
      '" id="Price' +
      window.i +
      '"></td><td><input type="number" name="total' +
      window.i +
      '" id="Total' +
      window.i +
      '"></td></tr>'
...
x.addEventListener("change", () => {
  ...
  fr.onloadend = (e) => {
    ...
    r.forEach((e, index) => {
      ...
      let d =
        e[2] === "Buy"
          ? `<option value="Buy" selected>Buy</option><option value="Sell">Sell</option>`
          : `<option value="Buy">Buy</option><option value="Sell" selected>Sell</option>`;
      ce.innerHTML =
        '<tr><td><input class="record" type="date" name="date' +
        index +
        '" id="Date' +
        ...
        '">' +
        d +
        '</select></td><td><input type="text" name="quantity' +
        index +
        '" id="Quantity' +
        index +
        '" value="' +
        e[3] +
        '"></td><td><input type="number" name="price' +
        index +
        '" id="Price' +
        index +
        '" value="' +
